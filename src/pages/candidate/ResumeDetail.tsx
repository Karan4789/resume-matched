      ...
      <DashboardLayout>
        <div className="space-y-6">
          <Alert variant="destructive">
            ...
            <AlertDescription>
              Resume analysis not found. Please try again or return to dashboard.
            </AlertDescription>
          </Alert>
    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <div>
            <Link to="/candidate-dashboard/resumes" className="text-muted-foreground hover:text-foreground flex items-center mb-2">
              <ArrowLeft className="mr-1 h-4 w-4" />
              Back to Resumes
            </Link>
            <h1 className="text-3xl font-bold tracking-tight">{analysis.jobTitle}</h1>
            <p className="text-muted-foreground">
              Resume analysis from {new Date(analysis.analysisDate).toLocaleDateString()}
            </p>
          </div>
            ...
            <CardContent>
              ...
              <div className="space-y-2 mt-2">
                ...
                <Progress 
                  ...
                  className={`h-2 ${analysis.atsScore >= 70 ? 'bg-green-200' : 'bg-amber-200'}`}
                />
              </div>
            </CardContent>
          </Card>
                        ...
                        {idx === 0 && (
                          <div className="mt-2 p-3 bg-muted rounded-md text-sm">
                            ...
                            <span className="text-muted-foreground">
                              ...
                              implementing complex state management with Redux for a healthcare
                              dashboard used by over 5,000 medical professionals."
                            </span>
                          </div>
                        )}
                      </div>
